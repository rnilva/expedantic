...
class SinkProtocol(Protocol):
    ...
    def write(
        self, data: dict[str, SupportedTypes], logger_name: str | None = None
    ) -> None:
...
class FileSink:
    ...
    def __init__(self, filepath: str | Path, mode: str = "a", encoding: str = "utf-8"):
...
class WandBSink:
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "wandb package is required for WandBSink. Install with: pip install wandb"
            )
...
class TensorBoardSink:
    ...
    def __init__(self, log_dir: str | Path, step_field: str = "iteration"):
        ...
        try:
            ...
            try:
                ...
                raise ImportError(
                    "tensorboardX or torch is required for TensorBoardSink. "
