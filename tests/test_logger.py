...
from expedantic.logger import (
    Field, MeanField, MaxField, MinField, SumField, ListField, 
    CountField, StdField, MedianField, LoggerBase, TrainingLogger
)
...
class TestTrainingLogger:
    ...
    def test_training_logger_realistic_usage(self):
        ...
        assert abs(entry['loss'] - 0.4) < 1e-10  # Mean of [0.5, 0.4, 0.3] = (0.5+0.4+0.3)/3 = 1.2/3 = 0.4
